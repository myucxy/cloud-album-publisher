...
public class DeviceSessionRepository {
    ...
    private static final String DEFAULT_BASE_URL = "http://192.168.9.28:8910";
    ...
    public boolean isBootAutoStartEnabled() {
        return preferences.getBoolean(KEY_BOOT_AUTO_START, false);
    }
    ...
    public static String sanitizeBaseUrl(String value) {
        ...
        try {
            ...
            int port = uri.getPort() > 0 ? uri.getPort() : 8910;
